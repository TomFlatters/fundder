  ...
  Widget build(BuildContext context) {
    ...
    return
        ...
        FutureBuilder<Template>(
            future: DatabaseService().getTemplateById(widget.templateData),
            builder: (BuildContext context, AsyncSnapshot<Template> template) {
              Template templateData = template.data;
              if (template.connectionState == ConnectionState.waiting) {
                return Loading();
              } else {
                if (template.hasError) {
                  print(templateData);
                  return Center(child: Text('Error: ${template.error}'));
                } else
                  return Scaffold(
                    appBar: AppBar(
                      centerTitle: true,
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                          howLongAgo(templateData.timestamp),
                                          style: TextStyle(
                                            fontSize: 14,
                                            color: Colors.grey,
                                          )),
                                    ...
                                    Container(
                                      ...
                                      child: LinearPercentIndicator(
                                        ...
                                        percent: double.parse(
                                                templateData.amountRaised) /
                                            double.parse(
                                                templateData.targetAmount),
